...
<div style="padding-top: 30px" id="main">
    <div style="text-align: center" class="col-md-12">
        ...
        if ((isset($_SESSION['conn']) and htmlentities($_SESSION['conn']) == 'connected')){
            ...
            echo "<h1>Êtes-vous sûr de vouloir vous déconnecter ?</h1>";
            echo "<form name='deconnexion' method='post' action='traitDeconnexion.php'>";
            echo "<input type='submit' name='submit' value='Déconnexion'>";
            echo "</form>";
