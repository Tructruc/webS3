<div id="sidebar" class="sidebar-offcanvas">
    <div style="padding-top: 30px;" class="col-md-12">
		...
		<?php
            ...
            $hidden = array("identification.php", "initTableaux.php", "traitConnexion.php", "index.php", "Deconnexion.php", "traitDeconnexion.php","cookieDelete.php", "tratCookieDelete.php");
